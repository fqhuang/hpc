# Spectrum MPI（BMS场景）<a name="ZH-CN_TOPIC_0075662285"></a>
...
## 操作步骤<a name="section8093762164412"></a>
...
3.  执行以下命令，在单个BMS上通过Spectrum MPI运行可执行文件。

    **$ mpirun -np 2 -pernode --hostfile hostfile /home/rhel/hello**

    **图 3**  集群上运行Spetrum MPI成功<a name="fig62705548164529"></a>  
    ![](figures/集群上运行Spetrum-MPI成功.png "集群上运行Spetrum-MPI成功")
